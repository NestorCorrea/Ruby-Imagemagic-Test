...
class ArtworksControllerTest < ActionController::TestCase
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post :create, artwork: { artwork: @artwork.artwork, artwork_file_name: @artwork.artwork_file_name, artwork_name: @artwork.artwork_name }
    end
  ...
  test "should update artwork" do
    put :update, id: @artwork, artwork: { artwork: @artwork.artwork, artwork_file_name: @artwork.artwork_file_name, artwork_name: @artwork.artwork_name }
    assert_redirected_to artwork_path(assigns(:artwork))
  end
